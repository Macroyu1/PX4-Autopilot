...
class Pos_Ctrl : public ModuleBase<Pos_Ctrl>, public ModuleParams, public control::SuperBlock,public px4::ScheduledWorkItem
{
	public:
		Pos_Ctrl();
	...
	private:
		...
		matrix::Vector3f thrust_onmi;
		DEFINE_PARAMETERS(
		(ParamFloat<px4::params::X_P>)         _param_x_p,
		(ParamFloat<px4::params::X_WC>)        _param_x_wc,
		(ParamFloat<px4::params::X_C2O>)       _param_x_c2o,
		(ParamFloat<px4::params::X_B0>)        _param_x_b0,

		(ParamFloat<px4::params::Y_P>)         _param_y_p,
		(ParamFloat<px4::params::Y_WC>)        _param_y_wc,
		(ParamFloat<px4::params::Y_C2O>)       _param_y_c2o,
		(ParamFloat<px4::params::Y_B0>)        _param_y_b0,

		(ParamFloat<px4::params::Z_P>)         _param_z_p,
		(ParamFloat<px4::params::Z_WC>)        _param_z_wc,
		(ParamFloat<px4::params::Z_C2O>)       _param_z_c2o,
		(ParamFloat<px4::params::Z_B0>)        _param_z_b0,

		(ParamFloat<px4::params::THR_HOVER>)    _param_mpc_thr_hover,
		(ParamBool<px4::params::USE_HTE>)       _param_mpc_use_hte,

		(ParamFloat<px4::params::XY_VEL_P>) _param_xy_vel_p,
		(ParamFloat<px4::params::XY_VEL_I>) _param_xy_vel_i,
		(ParamFloat<px4::params::XY_VEL_D>) _param_xy_vel_d,
		(ParamFloat<px4::params::Z_VEL_P>) _param_z_vel_p,
		(ParamFloat<px4::params::Z_VEL_I>) _param_z_vel_i,
		(ParamFloat<px4::params::Z_VEL_D>) _param_z_vel_d,
