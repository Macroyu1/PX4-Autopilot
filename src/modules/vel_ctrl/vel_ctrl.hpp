 ...
 * @LastEditTime: 2024-01-09 20:53:26
 * @FilePath: /PX4-Autopilot/src/modules/vel_ctrl/vel_ctrl.hpp
...
class Vel_Ctrl : public ModuleBase<Vel_Ctrl>, public ModuleParams, public px4::ScheduledWorkItem
{
	public:
		Vel_Ctrl();
	...
	private:
		...
		VelCtrl _control; /** 创建VelCtrl类的实例*/
